...
**Última actualización:** 18 de septiembre de 2026 (tras cerrar T-033)
...
**[T-034 · Fase 5: cometidos (explorar, portear, poblar, presencia)](docs/plan/T-034-cometidos.md)**

Lo que hace la recua al llegar: explorar (el conocimiento pasa a `explorada` y las vecinas a
`oida`), portear, poblar y fundar puebla, estar presente y disolver. Lee el apartado «Heredado de
T-033» de la ficha: las acciones de las paradas de ruta están por guardar en la recua.
...
| Motor | `resolverTurno` recorre las doce fases y firma el turno con su huella. Implementadas: 1 calendario, 2 producción (con los insumos de los edificios), 3 consumo, merma y escasez y 4 movimiento de recuas. Ciclo de vida de las órdenes en `src/ordenes.ts` |
